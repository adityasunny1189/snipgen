            ...
            <div>
                <div class=" relative my-6">
                    {#if snippetResponse !== undefined}
                        <pre class="my-4 p-4 break-all h-96 overflow-y-auto overflow-x-auto bg-[#1e1e1e] text-white rounded-lg"><code class="language-go">{@html Prism.highlight(snippetResponse, Prism.languages.go)}</code></pre>
